...
print(f"FPS: {vc.set(cv2.CAP_PROP_FPS, 30.0)}")
print(f"Frame width: {vc.set(cv2.CAP_PROP_FRAME_WIDTH, 1280)}")
print(f"Frame height: {vc.set(cv2.CAP_PROP_FRAME_HEIGHT, 800)}")
